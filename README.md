...
[![Go Report Card](https://goreportcard.com/badge/github.com/chrismlee26/makesite)](https://goreportcard.com/report/github.com/chrismlee26/makesite)
...
- [x] Read the contents of the provided `first-post.txt` file.
